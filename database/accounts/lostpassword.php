...
<body bgcolor="#999999">
<img src="gdmanagerLogo2.png" alt="GD Manager Logo" /></br><form action="./lostpassword.php" method="post" enctype="multipart/form-data>
  ...
  <dl>
	<div class="g-recaptcha" data-sitekey="6LeLCGcUAAAAACTr37ion5rWw-yDlAuFxDJgRz6w" data-callback="enableBtn"></div>
		...
		<button type="submit" id="button1" name="lostpass" value="lostpass" style="height:50px; width:100px; font-size:1rem;">Submit</button>
  </dl>
  </fieldset>
</form>
